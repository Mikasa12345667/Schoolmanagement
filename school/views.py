...
#for showing signup/login button for teacher(by Gabriel)
...
#for showing signup/login button for student(by Gabriel)
...
#for checking user is techer , student or admin(by Gabriel)
def is_admin(user):
...
#for dashboard of adminnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn(by Gabriel)
...
def admin_dashboard_view(request):
    ...
    #aggregate function return dictionary so fetch data from dictionay(by Gabriel)
    mydict={
